...
<head>
	<title>Tokopekita - Pencarian Program</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="products">
		<div class="container">
			<h2>Program Latihan Yang Anda Cari</h2>
			<div class="col-md-12 products-right">
				<div class="agile_top_brands_grids">
					<?php
					$x = mysqli_query($conn, "SELECT * from program where namaprogram like '%$s%' or deskripsi like '%$s%' order by idprogram ASC");
					$p = mysqli_num_rows($x);

					if ($p > 0) {
						while ($program = mysqli_fetch_array($x)) {
					?>
											...
											<figure>
												<div class="snipcart-item block">
													<div class="snipcart-thumb">
														<a href="detail_program.php?idprogram=<?php echo $program['idprogram'] ?>"><img title=" " alt=" " src="<?php echo $program['gambar'] ?>" width="200px" height="200px" /></a>
														<p><?php echo $program['namaprogram'] ?></p>
													</div>
													<div class="snipcart-details top_brand_home_details">
														<fieldset>
															<a href="detail_program.php?idprogram=<?php echo $program['idprogram'] ?>"><input type="submit" class="button" value="Lihat Program" /></a>
														</fieldset>
													</div>
												</div>
											</figure>
