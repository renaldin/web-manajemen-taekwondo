...
<head>
	<title>Taekwondo - Detail Program</title>
	<!-- for-mobile-apps -->
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active"><?php
									$p = mysqli_fetch_array(mysqli_query($conn, "Select * from program where idprogram='$idprogram'"));

									?>Detail Program Latihan</li>
			</ol>
		</div>
	</div>
	<!-- //breadcrumbs -->
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-details agileinfo_single_right_details" style="float: right;">
							<a href="program.php" class="btn btn-primary btn-sm">Kembali</a>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
