...
<head>
	<title>Taekwondo - Data Latihan Anak</title>
	<!-- for-mobile-apps -->
				...
				<table class="timetable_sub">
					...
					?>
						<tr class="rem1">
							...
							<td class="invert"><a href="detail_anak.php?idanak=<?php echo $a['idanak'] ?>"><?php echo $a['namaanak'] ?></a></td>
							<td class="invert"><?php echo $a['tingkat_sabuk'] ?></td>
							<td class="invert">
								<a href="detail_anak.php?idanak=<?php echo $a['idanak'] ?>" class="btn btn-sm btn-xs btn-primary">Detail</a>
							</td>
						</tr>
					<?php
					}
