...
<head>
	<title>Taekwondo - Kepengurusan Dojang</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Kepengurusan Dojang</li>
			</ol>
		</div>
	</div>
	<!-- //breadcrumbs -->
	...
	<div class="products">
		<div class="container">
			<h2>Kepengurusan Dojang</h2>
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile_top_brands_grids">
								<div class="col-md-12 top_brand_left" style="margin-bottom: 5px;">
									<div class="card h-100">
										...
										?>
											<div class="card-body">
												<object type="application/pdf" data="<?= $d['dokumen'] ?>" width="100%" height="850px">
												</object>
											</div>
										<?php } ?>
									</div>
