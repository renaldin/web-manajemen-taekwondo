...
<head>
	<title>Tokopekita - Pencarian Data Latihan Anak</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Program Latihan</li>
			</ol>
		</div>
	</div>
	<!-- //breadcrumbs -->
	...
	<div class="checkout">
		<div class="container">
			<h2>Daftar <span>Data Latihan Anak (Untuk Melihat Data Perkembangan Anda Bisa Klik Tombol Detail)</span></h2>
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<?php
					$x = mysqli_query($conn, "SELECT * from anak where namaanak like '%$s%' or tingkat_sabuk like '%$s%' or perkembangan_latihan like '%$s%' order by idanak ASC");
					$p = mysqli_num_rows($x);
					$no = 1;

					if ($p > 0) {
						while ($anak = mysqli_fetch_array($x)) {
					?>
							<tr class="rem1">
								<td class="invert"><?php echo $no++ ?></td>
								<td class="invert"><a href="detail_anak.php?idanak=<?php echo $anak['idanak'] ?>"><?php echo $anak['namaanak'] ?></a></td>
								<td class="invert"><?php echo $anak['tingkat_sabuk'] ?></td>
								<td class="invert">
									<a href="detail_anak.php?idanak=<?php echo $anak['idanak'] ?>" class="btn btn-sm btn-xs btn-primary">Detail</a>
								</td>
							</tr>
					<?php
						}
