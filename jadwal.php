...
<head>
	<title>TAEKWONDO - Jadwal Latihan</title>
	<!-- for-mobile-apps -->
							...
							<div class="agile_top_brands_grids">
									...
									<div class="hover14 column">
										<div class="agile_top_brand_left_grid">
											<div class="agile_top_brand_left_grid_pos">
												<button class="btn-sm" style="background-color: green; color: white;">Aktif</button>
											</div>
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															<a href="jadwal.php"><img alt=" " src="images/jam.png" width="200px" height="200px" /></a>
															<p class="text-left"><strong>Hari : Senin</strong></p>
															<p class="text-left">Waktu : 15:00 - 17:00</p>
														</div>
								...
								<div class="col-md-6 top_brand_left" style="margin-bottom: 5px;">
									<div class="hover14 column">
										<div class="agile_top_brand_left_grid">
											<div class="agile_top_brand_left_grid_pos">
												<button class="btn-sm" style="background-color: red; color: white;">Tidak Aktif</button>
											</div>
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															<a href="jadwal.php"><img alt=" " src="images/jam.png" width="200px" height="200px" /></a>
															<p class="text-left"><strong>Hari : Selasa</strong></p>
															<p class="text-left">Waktu : 15:00 - 17:00</p>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<fieldset>
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															<a href="jadwal.php"><img alt=" " src="images/jam.png" width="200px" height="200px" /></a>
															<p class="text-left"><strong>Hari : Rabu</strong></p>
															<p class="text-left">Waktu : 12:00 - 15:00</p>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<fieldset>
																<button class="" style="background-color: darkblue; width: 100%; height: 30px;"></button>
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															<a href="jadwal.php"><img alt=" " src="images/jam.png" width="200px" height="200px" /></a>
															<p class="text-left"><strong>Hari : Kamis</strong></p>
															<p class="text-left">Waktu : 13:00 - 16:00</p>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<fieldset>
																<button class="" style="background-color: darkblue; width: 100%; height: 30px;"></button>
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															<a href="jadwal.php"><img alt=" " src="images/jam.png" width="200px" height="200px" /></a>
															<p class="text-left"><strong>Hari : Jum'at</strong></p>
															<p class="text-left">Waktu : 14:00 - 17:00</p>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<fieldset>
																<button class="" style="background-color: darkblue; width: 100%; height: 30px;"></button>
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															<a href="jadwal.php"><img alt=" " src="images/jam.png" width="200px" height="200px" /></a>
															<p class="text-left"><strong>Hari : Sabtu</strong></p>
															<p class="text-left">Waktu : 08:00 - 10:00</p>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<fieldset>
																<button class="" style="background-color: darkblue; width: 100%; height: 30px;"></button>
